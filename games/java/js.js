...
if (event.keyCode == 27)
{
document.getElementById('overlay').style.display = 'none';document.getElementById('div_dialog_background').style.display = 'none';document.getElementById('overlay').style.display = 'none';
...
if (event.keyCode == 36)
{
window.location="//games-subins.hp.af.cm/files/Home.php";
}
if (event.keyCode == 80)
{
...
if (location.href=='//games-subins.hp.af.cm/files/Home.php') 
...
if (VisitorName == null)
{
window.location="//friendshood.com/";
}
}
function Large(obj)
{
