 ...
 * Web: //medialize.github.com/jQuery-contextMenu/
 *
 * Licensed under
 *   MIT License //www.opensource.org/licenses/mit-license
 *   GPL v3 //opensource.org/licenses/GPL-3.0
 *
 */
...
var // currently active contextMenu trigger
    ...
    handle = {
        ...
        contextmenu: function(e) {
            ...
            if (!$this.hasClass('context-menu-disabled')) {
                ...
                // //www.whatwg.org/specs/web-apps/current-work/multipage/interactive-elements.html#context-menus
    ...
    op = {
        ...
        hide: function(opt, force) {
            ...
            //$(document).off('.contextMenuAutoHide keydown.contextMenu'); // //bugs.jquery.com/ticket/10705
...
// split accesskey according to //www.whatwg.org/specs/web-apps/current-work/multipage/editing.html#assigned-access-key
    ...
    switch (operation) {
        case 'create':
            ...
            switch (o.trigger) {
                ...
                /*
                default:
                    // //www.quirksmode.org/dom/events/contextmenu.html
                    $document
...
function menuChildren(items, $children, counter) {
    ...
    $children.each(function() {
        ...
        // //www.whatwg.org/specs/web-apps/current-work/multipage/commands.html#concept-command
        switch (nodeName) {
            // //www.whatwg.org/specs/web-apps/current-work/multipage/interactive-elements.html#the-menu-element
            case 'menu':
                item = {name: $node.attr('label'), items: {}};
                counter = menuChildren(item.items, $node.children(), counter);
                break;
            
            // //www.whatwg.org/specs/web-apps/current-work/multipage/commands.html#using-the-a-element-to-define-a-command
            case 'a':
            // //www.whatwg.org/specs/web-apps/current-work/multipage/commands.html#using-the-button-element-to-define-a-command
            case 'button':
                item = {
                    name: $node.text(),
            ...
            // //www.whatwg.org/specs/web-apps/current-work/multipage/commands.html#using-the-command-element-to-define-a-command
