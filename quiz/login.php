...
<head>
<script>
window.location='//accounts-subins.hp.af.cm/login.php?service=quiz';
</script>
...
<form name="password1" action="//accounts-subins.hp.af.cm/login.php?service=quiz" method="post" ONKEYDOWN="if (event.keyCode == 13){var btn = document.getElementById('login');btn.click();}">
...
?>
<br /><div id="bg"><center style="padding-top: 60px;">Answer Questions</center></div>
...
<a href="//quiz.subins.hp.af.cm/login.php"><input type="button" value="Log In Again"></a>
</center>
</h1>
</div>
