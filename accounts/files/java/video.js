...
along with Video.js.  If not, see <//www.gnu.org/licenses/>.
*/
...
}// Using John Resig's Class implementation //ejohn.org/blog/simple-javascript-inheritance/
...
_V_.ControlBar = _V_.Component.extend({
  ...
  init: function(player, options){
    ...
    player.addEvent("play", this.proxy(function(){
      ...
      document.getElementById('duration')=this.player.duration;
    }));
...
// Reference: //es5.github.com/#x15.4.4.18
...
// Reference: //es5.github.com/#x15.4.4.19
...
//   };      
// }
// Event System (J.Resig - Secrets of a JS Ninja //jsninja.com/ [Go read it, really])
...
_V_.html5.prototype.support = {
  ...
  // //developer.apple.com/library/safari/#documentation/AudioVideo/Reference/HTMLVideoElementClassReference/HTMLVideoElement/HTMLVideoElement.html
  // Seems to be broken in Chromium/Chrome && Safari in Leopard
...
_V_.TextTrackDisplay = _V_.Component.extend({
  ...
  createElement: function(){
    return this._super("div", {
      ...
      innerHTML: '<div id="vid-logo"><a href="//videos.subins.hp.af.cm"><img height="40px" src="images/logo.jpg"></a></div>'
    });
  }
});
