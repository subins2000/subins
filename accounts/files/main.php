...
Email:<br><input class="input" type="email" name="email" id="email" size="18" maxlength="35" value=""><span id="c" hidden><font color="red">You didnt type your email</font></span>
<center>
</center>
Age:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="input" type="number" name="age" id="age" size="18" maxlength="20" value=""><span id="e" hidden><font color="red">You didnt type your age</font></span><br /><br>
