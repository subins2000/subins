...
<head>
<script>
window.location='//accounts-subins.hp.af.cm/login.php?service=subins';
</script>
...
window.location='//subins.hp.af.cm/';
}
</script>
...
<form name="password1" action="//accounts-subins.hp.af.cm/login.php?service=subins" method="post" ONKEYDOWN="if (event.keyCode == 13){var btn = document.getElementById('login');btn.click();}">
...
?>
<br /><div id="bg"><center style="padding-top: 60px;">Connect to people in the world using LocalHost.</center></div>
