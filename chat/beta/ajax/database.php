...
/*
	...
	based on the database abstraction file from osCommerce (//oscommerce.com)
...
//password = The password to connect to the database.
  function db_connect($server = 'localhost', $username = 'root', $password = 'backstreetboys', $database = 'db', $link = 'db_link') {
    global $$link;
